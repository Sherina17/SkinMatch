// ===== DATA =====
    const productImageMap = {
        "skintific toner 5% aha bha pha exfoliating 80ml": "image/Skintific Toner 5% AHA BHA PHA Exfoliating 80ml.jpeg",
        ...
        "skintific 12% aha bha pha lha peeling solution": "image/Skintific 12% AHA BHA PHA LHA Peeling Solution.webp",
        ...
        "skintific acne serum 2% salicylic acid": "image/Skintific Acne Serum 2% Salicylic Acid.jpeg",
        "skintific 10% niacinamide brightening serum": "image/Skintific 10% Niacinamide Brightening Serum.jpeg",
        "skintific serum 3% tranexamic acid advanced bright 20ml": "image/Skintific Serum 3% Tranexamic Acid Advanced Bright 20ml.jpeg",
        ...
        "skintific 5% panthenol acne calming water gel": "image/Skintific 5% Panthenol Acne Calming Water Gel.png",
        ...
        products.forEach((product, idx) => {
            ...
            summary.innerHTML = `
                <div class="summary-row">
                    <span class="summary-label">Fokus Concern</span>
                    <span>${product.concerns.slice(0,2).map(c =>
                        toTitleCase(String(c).replace(/-/g,' '))
                    ).join(', ') || '-'}</span>
                </div>

                <div class="summary-row">
                    <span class="summary-label">Kandungan Utama</span>
